...
// We are going to replace everything from `// M15 Swept & CISD Confirmed`
// to the end of `analyzeSequence` method.
// And also delete `detectDynamicOrderBlock` and `validateRetracement`.
