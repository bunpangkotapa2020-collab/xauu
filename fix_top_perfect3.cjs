...
if (importStart > -1 && dotenvIndex > -1) {
    ...
    let interfaceEnd = finalCode.indexOf('\nconst DEFAULT_BOT_CONFIG', interfaceStart);
    if (interfaceEnd === -1) interfaceEnd = finalCode.indexOf('\nconst botState', interfaceStart);
