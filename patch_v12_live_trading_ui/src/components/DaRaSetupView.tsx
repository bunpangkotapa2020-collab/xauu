              ...
              <div className="flex items-center gap-2 sm:gap-2.5 flex-wrap">
                ...
                {state.riskConfig?.liveTradingEnabled ? (
                  <button 
                    ...
                    className="text-[11px] font-bold px-3 py-1.5 rounded-lg uppercase tracking-wider bg-red-600/90 border border-red-500 text-white whitespace-nowrap shadow-[0_0_15px_rgba(220,38,38,0.5)] animate-pulse hover:bg-red-500 cursor-pointer"
                  >
                    🔴 LIVE TRADING ACTIVE (ចុចបិទ/OFF)
                  </button>
                ) : (
                  <div className="flex items-center gap-2">
                    ...
                    <button 
                      ...
                      className="text-[11px] font-bold px-3 py-1.5 rounded-lg uppercase tracking-wider bg-slate-800 hover:bg-slate-700 border border-slate-600 text-slate-300 whitespace-nowrap cursor-pointer shadow-lg transition-colors"
                    >
                      ▶️ ចុចបើក LIVE TRADING (Turn ON)
                    </button>
                  </div>
                )}
